...
export const GENERAL = (i18n: I18n): StrategyGeneralInfo => ({
  ...
  steps: [i18n._(t`ENERGYFI`), i18n._(t`crXENERGYFI`), i18n._(t`BentoBox`)],
  zapMethod: 'stakeEnergyFiToCreamToBento',
  unzapMethod: 'unstakeEnergyFiFromCreamFromBento',
  description: i18n._(t`Stake ENERGYFI for xENERGYFI into Cream and deposit crXENERGYFI into BentoBox in one click.`),
  inputSymbol: i18n._(t`ENERGYFI`),
  outputSymbol: i18n._(t`crXENERGYFI in BentoBox`),
})
