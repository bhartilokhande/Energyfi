  ...
  return (
    <div
      ...
      className={classNames(
        isActive ? 'text-high-emphesis' : 'text-white',
        'flex justify-between p-4 hover:bg-field'
      )}
      key={listUrl}
    >
      <div className="flex gap-3">
        ...
        <div className="flex flex-col">
          <Typography
            weight={700}
            className={classNames(isActive ? 'text-white' : 'text-white', 'overflow-hidden overflow-ellipsis')}
          >
            {list.name}{' '}
  ...
  return (
    <>
      <input
        ...
        className="w-full bg-field border border-Gray focus:border-Indigo rounded-[0.350rem] placeholder-secondary font-bold text-base p-4 appearance-none"
        value={listUrlInput}
        ...
        >
          ...
          <div className="flex justify-between">
            <div className="flex gap-3">
              ...
              <div className="flex flex-col">
                <Typography weight={700} className={classNames('text-white overflow-hidden overflow-ellipsis')}>
                  {tempList?.name}{' '}
                  {tempList && (
                    <Typography variant="xs" weight={700} component="span">
      ...
      <div className="h-full overflow-y-auto bg-black/10 rounded-sm overflow-hidden">
