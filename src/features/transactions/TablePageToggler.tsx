  ...
  return (
    <>
      ...
      <div className="select-none mb-16 lg:hidden">
        <div className="rounded-t overflow-hidden border border-Gray bg-popupBg flex justify-between p-3">
          <span>{i18n._(t`Showing Results`)}</span>
          <span className="text-high-emphesis"> {summaryString}</span>{' '}
        </div>
        <div className="border-b rounded-b border-l border-r border-Gray bg-ternary overflow-hidden flex justify-between">
          <div
            onClick={() => gotoPage(pageIndex - 1)}
            className={`flex-grow border-r p-3 border-Gray ${
