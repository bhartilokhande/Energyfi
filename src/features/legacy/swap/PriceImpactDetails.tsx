...
const PriceImpactDetails: FC<PriceImpactDetails> = ({ inputCurrency, outputCurrency, recipient, trade, className, handleClose, handleSwap }) => {
    ...
    return (
        <Disclosure as="div">
            ...
            >
                <div className='flex items-center justify-end cursor-pointer rounded' onClick={handleClose}>x</div>
                <div className='flex justify-between  items-center mb-10'>
                    <WarningIcon />
                    <Typography style={{color:'red',fontSize:"16px"}}>Price impact is too high,This action can not be undone.</Typography>
                </div>
                ...
                <Button variant='outlined' onClick={handleSwap} className="bg-red border-none hover:bg-red border-red mt-10">Swap Anyway</Button>
            </div>
...
const PriceImpactContent: FC<PriceImpactDetailsContent> = ({ trade, recipient }) => {
