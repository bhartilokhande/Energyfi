...
export function ConfirmAddModalBottom({
  ...
  return (
    <div className="p-6 mt-0 -m-6 rounded">
      ...
      <Divider className="border-Gray my-6" />
      ...
      <Button color="btn_primary" className="h-12 text-white rounded-[0.350rem]" fullWidth onClick={onAdd}>
