...
const LimitOrderButton: FC<LimitOrderButton> = ({ trade, parsedAmounts, className }) => {
  ...
  return (
    <>
      {permitError && (
        <Typography variant="sm" className="p-4 mt-4 text-center border rounded border-yellow/40 text-yellow">
          {i18n._(
        ...
        {({ approved, loading }) => {
          ...
          return (
            <Button
              ...
              disabled={disabled}
              onClick={handler}
              className="rounded-[0.350rem] h-12 w-full"
            >
