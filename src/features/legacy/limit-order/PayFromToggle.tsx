      ...
      <Switch.Group>
        <div className="flex items-center">
          <Switch.Label className="mr-2">
            <Typography variant="sm" className={!fromBentoBalance ? 'text-white' : 'text-secondary'}>
              {i18n._(t`Wallet`)}
            </Typography>
          </Switch.Label>
          <Switch
          ...
          <Switch.Label className="ml-2">
            <Typography variant="sm" className={fromBentoBalance ? 'text-white' : 'text-low-emphesis'}>
              BentoBox
            </Typography>
          </Switch.Label>
        </div>
