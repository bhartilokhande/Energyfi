      ...
      <div className={classNames('')}>
        ...
        <div className={classNames(COLUMN_CONTAINER, content ? 'hidden' : '')}>
          <HeadlessUiModal.Header
            header={
              <div className="flex gap-0.5 items-center">
                ...
                <QuestionHelper className="!max-w-[17rem] p-1 font-normal bg-popupBg border border-Gray rounded-md text-sm overflow-auto hide-scrollbar" text={<InformationDisclosure farm={farm} />} />
              </div>
            }
            onClose={onDismiss}
          />
          ...
          >
            ...
            <ToggleButtonGroup.Button value={OnsenModalView.Staking}>{i18n._(t`Farm`)}</ToggleButtonGroup.Button>
