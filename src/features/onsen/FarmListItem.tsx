...
const FarmListItem: FC<FarmListItem> = ({ farm, onClick, farmListCss }) => {
  ...
  return (
    <div className={classNames('grid  grid-cols-4 cursor-pointer', farmListCss)} onClick={onClick}>
      ...
      <div className={classNames('flex flex-col maxLg:mr-12 !items-end !justify-center mr-16', TABLE_TBODY_TD_CLASSNAME(2, 4))}>
        {/* @ts-ignore TYPE NEEDS FIXING */}
      ...
      <div className={classNames('flex flex-col !items-end', TABLE_TBODY_TD_CLASSNAME(3, 4))}>
        <Typography weight={700} className="flex gap-0.5 items-center text-white">
          {farm?.tvl !== 0
