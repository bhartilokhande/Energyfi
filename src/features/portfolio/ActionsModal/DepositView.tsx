  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex justify-center -mt-6 -mb-6 z-10">
        <div className="p-1.5 rounded-full bg-black-700 border border-dark-800 shadow-md border-dark-700">
          <ArrowDownIcon width={14} className="text-white" />
        </div>
      </div>
      <HeadlessUiModal.BorderedContent className="bg-black/50 flex gap-3 px-3">
