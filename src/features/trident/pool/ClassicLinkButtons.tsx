  ...
  return (
    <div className="grid grid-cols-1 gap-2 lg:grid-cols-2">
      {poolBalance?.greaterThan(0) ? (
        <>
          <Button id={`btn-remove-liquidity`} variant="outlined" color="btn_primary">
            <Link
              href={{
          ...
          <Button id={`btn-add-stake-liquidity`} variant="outlined" color="btn_primary">
            <Link
              href={{
      ...
      <Button color="btn_primary" className={classNames(poolBalance?.greaterThan(0) && 'col-span-2')}>
        <Link
          href={{
