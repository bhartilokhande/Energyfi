      ...
      <Container maxWidth="5xl" className="flex flex-col gap-8 px-4 py-8">
        <div className="flex items-center gap-8">
          <div className="min-w-[140px] min-h-[105px]">
            <Image src="https://app.energyFi.com/images/inari/neon-sign.png" alt="inari-sign" width={140} height={105} />
          </div>
          <div className="flex flex-col">
            ...
            <Typography>
              {i18n._(t`Take your Energyfi and invest in various strategies with one click! Earn extra yields with BentoBox, use as
