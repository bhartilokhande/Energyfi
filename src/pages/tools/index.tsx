...
const TOOLS = (i18n: I18n) => [
  {
    id: 1,
    name: 'MEOWSHI',
    description: i18n._(t`Redenominate xEnergyFi into MEOWSHI`),
    href: '/tools/meowshi',
  },
  {
    id: 2,
    name: 'INARI',
    description: 'Deposit Energyfi in various strategies & platforms in one click!',
    href: '/tools/inari',
  },
]
...
export default function Tools() {
  ...
  return (
    <Container id="tools-page" className="py-4 space-y-4 md:py-8 lg:py-12" maxWidth="xl">
      <Head>
        <title>Tools | Energyfi</title>
        <meta key="description" name="description" content="EnergyFiSwap tools..." />
        <meta key="twitter:description" name="twitter:description" content="EnergyFiSwap tools..." />
        <meta key="og:description" property="og:description" content="EnergyFiSwap tools..." />
      </Head>
                ...
                <Link href={tool.href}>
                  <a className="flex items-center justify-between focus:outline-none">
                    ...
                    <div className="space-y-1">
                      <p className="text-xl font-bold truncate text-white">{tool.name}</p>
