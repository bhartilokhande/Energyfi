...
export default function Remove() {
  ...
  const ModalBottom = (
    <div className="p-6 mt-0 -m-6">
      ...
      <Button
        color="btn_primary"
        className='!h-10 w-full rouded-[0.350rem] text-white'
  ...
  return (
    <Container id="remove-liquidity-page" className="space-y-4 px-2 pt-10 pb-10 md:pb-20" maxWidth="2xl">
      <Head>
        <title>Remove Liquidity | Energyfi</title>
        <meta key="description" name="description" content="Remove liquidity from the EnergyFiSwap AMM" />
        <meta key="twitter:description" name="twitter:description" content="Remove liquidity from the EnergyFiSwap AMM" />
        <meta key="og:description" property="og:description" content="Remove liquidity from the EnergyFiSwap AMM" />
      </Head>
      ...
      <DoubleGlowShadow>
        <div className="p-4 space-y-4 rounded bg-ternary" style={{ zIndex: 1 }}>
          ...
          <div>
            ...
            <AutoColumn gap="md">
              <div>
                ...
                <div id="remove-liquidity-output" className="p-5 rounded bg-ternary">
                  <div className="flex flex-col justify-between space-y-3 sm:space-y-0 sm:flex-row">
                        ...
                        {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                          <RowBetween className="text-sm">
                            {oneCurrencyIsETH ? (
                              ...
                              >
                                <a className="text-baseline text-Green opacity-80 hover:opacity-100 focus:opacity-100 whitespace-nowrap">
                                  {/* @ts-ignore TYPE NEEDS FIXING */}
                    ...
                    <div className="flex flex-col space-y-3 md:flex-row md:space-x-6 md:space-y-0">
                      <div className="flex flex-row items-center w-full p-3 pr-8 space-x-3 rounded bg-popupBg">
              ...
              <div style={{ position: 'relative' }}>
                {!account ? (
                  <Web3Connect size="lg" color="btn_primary" className="text-white w-full h-10 rounded-[0.350rem]" />
                ) : (
                  <div className="grid grid-cols-2 gap-4">
                    <Button
                      fullWidth
                      color='btn_primary'
                      className="w-full !h-10 rounded-[0.350rem] text-white"
