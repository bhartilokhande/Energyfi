...
export default function Status({ initialData }) {
  ...
  //   const { data } = res.data
  return (
    <Container id="status-page" className="px-2 pt-10 pb-10 md:pb-20 mx-auto" maxWidth="full">
      <Head>
        <title>Status | Energyfi</title>
        <meta key="description" name="description" content="Energyfi Status..." />
        <meta key="twitter:description" name="twitter:description" content="Energyfi Status..." />
        <meta key="og:description" property="og:description" content="Energyfi Status..." />
      </Head>
          ...
          <Tab.Panel>
            <div className="grid items-start justify-start grid-cols-3 gap-4 mx-auto ">
              {data.items.map((item) => {
                ...
                return (
                  <div className="p-4 rounded bg-dark-900 text-white">
