...
const MigrateLiquidity = () => {
  ...
  return (
    <>
      <Head>
        <title>{i18n._(t`Migrate Liquidity | Energyfi`)}</title>
      </Head>
      <DebugObserver />
      <TridentHeader className="!gap-2">
        <Typography variant="h2" className="text-high-emphesis" weight={700}>
          {i18n._(t`Migrate Liquidity`)}
        </Typography>
        <div className="max-w-2xl">
          <Typography className="text-high-emphesis" weight={700}>
            {i18n._(t`Select and migrate your liquidity positions from Energyfi v1 to the Trident AMM`)}
          </Typography>
