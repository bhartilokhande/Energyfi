...
export default function Create() {
  ...
  return (
    <CreateLayout>
      <Head>
        <title>Create Lending Pair | Kashi by Energyfi</title>
        <meta key="description" name="description" content="Create Lending Pair on Kashi by Energyfi" />
        <meta key="twitter:description" name="twitter:description" content="Create Lending Pair on Kashi by Energyfi" />
        <meta key="og:description" property="og:description" content="Create Lending Pair on Kashi by Energyfi" />
      </Head>
      <Card
      ...
      >
        <Container maxWidth="full" className="space-y-6">
          ...
          <Button
            color="btn_primary"
            className="w-full px-4 py-3 text-base rounded text-white"
