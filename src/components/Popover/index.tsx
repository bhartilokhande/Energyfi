...
export default function Popover({ content, children, className, placement = 'auto', show, modifiers }: PopoverProps) {
          ...
          {(show ?? open) &&
            ReactDOM.createPortal(
              <HeadlessuiPopover.Panel
                static
                className={classNames(className, "z-[15] box_shadow_1 overflow-hidden",)}
