...
const purple1 = '#A466FF'
const purple2 = '#0FB871'
...
const Curves = ({
  ...
  return (
    <div className="relative h-full w-full" style={{ width }}>
          ...
          {timespans?.map((t) => (
            <button
              ...
              className={classNames(
                t === timespan
                  ? 'text-primary bg-primary bg-opacity-20 rounded-xl font-bold border border-primary border-opacity-50'
                  : 'text-Gray',
                'text-sm px-3 py-0.5'
              )}
              onClick={() => {
