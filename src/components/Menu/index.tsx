...
const items = (i18n: I18n) => [
  {
    name: i18n._(t`Docs`),
    description: i18n._(t`Documentation for users of Energyfi.`),
    href: 'https://docs.energyfi.com',
  },
  {
    name: i18n._(t`Dev`),
    description: i18n._(t`Documentation for developers of Energyfi.`),
    href: 'https://dev.energyfi.com',
  },
  {
    name: i18n._(t`Open Source`),
    description: i18n._(t`Energyfi is a supporter of Open Source.`),
    href: 'https://github.com/energyfiswap',
  },
  {
    name: i18n._(t`Tools`),
...
export default function Menu() {
  ...
  return (
    <Popover className="relative">
      {({ open }) => (
        <>
          <Popover.Button className={classNames(open ? 'text-secondary' : 'text-white', 'focus:outline-none')}>
            <Image
              src="/menu.svg"
              title="More"
