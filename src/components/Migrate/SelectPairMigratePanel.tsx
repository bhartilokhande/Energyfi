...
export const SelectPairMigratePanel: FC<PanelProps> = ({ pair, source, setFunc, checkedState }) => {
  return (
    <div className="w-full border border-1 border-Gray rounded">
      <div className="flex justify-between p-3 bg-ternary items-center rounded-t">
        <PoolPanelAssetsLabel pair={pair} />
        <div className="flex">
          <Button color="green" variant="outlined" size="xs">
            {source}
          </Button>
