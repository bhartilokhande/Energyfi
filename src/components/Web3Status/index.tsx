  ...
  if (connector === injected) {
    return (
      <div className="flex flex-col items-center justify-center w-4 h-4 flex-nowrap">
        <Image
          src="https://app.energyfi.com/images/wallets/metamask.png"
    ...
    return (
      <div className="flex flex-col items-center justify-center w-4 h-4 flex-nowrap">
        <Image
          src="https://app.energyfi.com/images/wallets/wallet-connect.svg"
          alt={'Wallet Connect'}
          width="16px"
          height="16px"
        />
    ...
    return (
      <div className="flex flex-col items-center justify-center w-4 h-4 flex-nowrap">
        <Image src="https://app.energyfi.com/images/wallets/lattice.png" alt={'Lattice'} width="16px" height="16px" />
      </div>
    )
    ...
    return (
      <div className="flex flex-col items-center justify-center w-4 h-4 flex-nowrap">
        <Image
          src="https://app.energyfi.com/images/wallets/coinbase.svg"
          alt={'Coinbase Wallet'}
          width="16px"
          height="16px"
        />
    ...
    return (
      <div className="flex flex-col items-center justify-center w-4 h-4 flex-nowrap">
        <Image src="https://app.energyfi.com/images/wallets/fortmatic.png" alt={'Fortmatic'} width="16px" height="16px" />
      </div>
    )
  } else if (connector.constructor.name === 'PortisConnector') {
    return (
      <div className="flex flex-col items-center justify-center w-4 h-4 flex-nowrap">
        <Image src="https://app.energyfi.com/images/wallets/portis.png" alt={'Portis'} width="16px" height="16px" />
      </div>
    )
  } else if (connector.constructor.name === 'KeystoneConnector') {
    return (
      <div className="flex flex-col items-center justify-center w-4 h-4 flex-nowrap">
        <Image src="https://app.energyfi.com/images/wallets/keystone.png" alt={'Keystone'} width="16px" height="16px" />
      </div>
    )
  } else if (connector.constructor.name === 'CloverConnector') {
    return (
      <div className="flex flex-col items-center justify-center w-4 h-4 flex-nowrap">
        <Image src="https://app.energyfi.com/images/wallets/clover.svg" alt={'Clover'} width="16px" height="16px" />
      </div>
    )
  }
  return null
...
interface Web3StatusInnerProps {
  web3ConnectClass?: string
}
const Web3StatusInner: FC<Web3StatusInnerProps> = ({ web3ConnectClass }) => {
  ...
  if (account) {
    return (
      <div
        ...
        className="flex items-center gap-2 px-3 py-2 text-sm text-white cursor-pointer"
    ...
    return (
      <Web3Connect className={classNames("text-white", web3ConnectClass)} />
    )
  }
}
...
const Web3Status: FC<Web3StatusProps> = ({ web3ConnectClass }) => {
  ...
  return (
    <>
      <Web3StatusInner web3ConnectClass={web3ConnectClass} />
