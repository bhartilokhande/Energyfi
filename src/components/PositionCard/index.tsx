  ...
  return (
    <>
      {userPoolBalance && JSBI.greaterThan(userPoolBalance.quotient, JSBI.BigInt(0)) ? (
        <div className="p-5 rounded bg-popupBg text-white">
          <AutoColumn gap={'md'}>
            ...
            <div className="flex flex-col w-full p-3 mt-3 space-y-1 text-sm rounded bg-ternary text-high-emphesis">
    ...
    >
      <Button
        ...
        className={classNames(
          'flex items-center justify-between w-full h-12 cursor-pointer text-white maxSm:px-2'
        )}
      ...
      >
        ...
        <div className="flex items-center !font-medium ml-3">
          {i18n._(t`Manage`)}
          {showMore ? (
            <ChevronUpIcon width="20px" height="20px" className="ml-2" />
          ) : (
      ...
      >
        <div className="p-4 space-y-4">
          <div className="space-y-1 text-sm rounded text-high-emphesis bg-ternay">
