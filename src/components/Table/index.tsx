              ...
              <tr key="tr" {...headerGroup.getHeaderGroupProps()}>
                ...
                {headerGroup.headers.map((column, i, columns) => (
                  ...
                  <th key={i} {...column.getHeaderProps(column.getSortByToggleProps())}>
                    ...
                    >
                      <div className="flex flex-row text-sm text-white py-4 !font-normal">
                        <div
                          className={classNames(
                            //@ts-ignore TYPE NEEDS FIXING
                        ...
                        >
                          ...
                          {column.HideHeader && isHidden && (
                            <button onClick={(e) => toggleHide(e)} className="text-white">
                        ...
                        >
                          <div
                            className={classNames(
                              ...
                              link && 'cursor-pointer',
                              'h-20 text-white bg-popupBg flex items-center'
                            )}
                          >
                            <div
                              className={classNames(
          ...
          <div className="flex text-sm font-normal text-secondary">
            ...
            >
              {[10, 20, 30, 40, 50].map((pageSize) => (
                <option className="bg-black-700" key={pageSize} value={pageSize}>
                  {pageSize}
                </option>
              ))}
            </select>
