            ...
            <div className={classNames(index === _index ? '' : 'hidden', 'flex flex-col gap-8')}>
              ...
              <div
                className={classNames(
                  ...
                  'flex items-center pt-10 border-t-2 border-Gray'
                )}
              >
                {hasPrev && (
                  <div>
                    <Button variant="outlined" color="green" className='h-10 rounded-[0.350rem]' onClick={setPrev} type="button">
                      {i18n._(t`Previous`)}
                    </Button>
                  </div>
                )}
                {hasNext && (
                  <div>
                    <Button variant="filled" color="green" className='h-10 rounded-[0.350rem]' onClick={setNext} type="button">
                      {i18n._(t`Next`)}
                    </Button>
                  </div>
                )}
